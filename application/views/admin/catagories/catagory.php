    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?= lang('Catagories') ?>
                    <a href="javascript:void(0)" type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#insertModal"><?= lang('addCatagory') ?></a></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card"> 
            <div class="row">      
                <div class="col-md-12"> 
                    <div class="card-body">          
                        <?php if (isset($catagories_data) && !empty($catagories_data)): ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?= lang('addCatagory') ?></h5>
      ...
      <div class="modal-body">
        ...
        <form method="post" id="quickForm" enctype="multipart/form-data" class="insert_data">
            <div class="form-group">
                <label for="cat_text"><?= lang('FieldTitle') ?></label>
                <input type="text" name="cat_text" class="form-control" placeholder="<?= lang('FieldTitle') ?>" required>
            </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?= lang('editCatagory') ?></h5>
        <button type="button" class="close"data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <form method="post" id="quickForm" enctype="multipart/form-data" class="update_data">
            <div class="form-group">
                <label for="cat_text"><?= lang('FieldTitle') ?></label>
                <input type="text" id="cat_text" name="cat_text" class="form-control" placeholder="<?= lang('FieldTitle') ?>" required>
            </div>
    ...
    $(document).ready(function () {
        ...
        function get_datatable() {
            $('#data_table').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo base_url('/cataloguecontroller/data_table_catagory') ?>",
                    "type": "POST"
                },
                "columnDefs": [{
                        "targets": [0],
        ...
        $.validator.setDefaults({           
            ...
            submitHandler: function () {
                $.ajax({
                    url: '<?php echo base_url('/cataloguecontroller/save_catagory'); ?>',
                    type: "POST",
            ...
            if(get_title=="Edit"){
                ...
                $.ajax({
                    ...
                    beforeSend: function (xhr) {
                        ...
                        $("#cat_text").val(resp.cat_name);
                        $("#edit_id").val(resp.cat_id);                        
        ...
        $.validator.setDefaults({           
            ...
            submitHandler: function () {
                $.ajax({
                    url: '<?php echo base_url('/cataloguecontroller/update_catagory'); ?>',
                    type: "POST",
