...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <p class="text-dark">Company:
                        <?= (isset($selected_company) && !empty($selected_company))?$selected_company->cmp_text:''; ?>
                    </p>
                    <h1><?= lang('teams') ?></h1>
...
$(document).ready(function() {
    ...
    function get_datatable() {
        $('#data_table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo base_url('/assignusercontroller/data_table_team') ?>",
                "type": "POST",
                "data": {
    ...
    $("body").on("click", ".admin_action", function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        url: "<?php echo base_url('assignusercontroller/add_team_to_company'); ?>",
                        type: "post",
                        dataType: "json",
                        data: {
                            'company_id': "<?php echo $_REQUEST['company'] ?>",
