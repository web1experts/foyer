    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" id="quickForm" enctype="multipart/form-data" class="update_data">
            ...
            <div class="form-group">
                <label for="guest_subject"><?= lang('ratingus') ?></label>
                <select class="form-control" name="rating_us" id="rating_us">
            ...
            <div class="form-group">
                <label for="guest_subject"><?= lang('recomend_us') ?></label>
                <select class="form-control" name="recomend_us" id="recomend_us">
    ...
    $(document).ready(function () {
        ...
        function get_datatable() {
            $('#data_table').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo base_url('/reviewscontroller/data_table_reviews') ?>",
                    "type": "POST"
                },
                "columnDefs": [{
                        "targets": [0],
        ...
        $("body").on("click", ".user_action", function(){
            ...
            if(get_title=="Edit"){
                ...
                $.ajax({
                    url: '<?php echo base_url('/reviewscontroller/contact_edit'); ?>',
                    type: "POST",
                    ...
                    beforeSend: function (xhr) {
                        ...
                        $("#guest_email").val(resp.guest_email);
                        $("#rating_us").val(resp.rate);
                        $("#recomend_us").val(resp.recomend_us);
        ...
        $.validator.setDefaults({           
            ...
            submitHandler: function () {
                $.ajax({
                    url: '<?php echo base_url('/reviewscontroller/update_reviews'); ?>',
                    type: "POST",
